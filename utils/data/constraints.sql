...
VALUES
(40,'Brown Brim',3,'a25','https://i.ibb.co/ZYW3VTp/brown-brim.png','/img/hats/brown-brim.png')

-- 關聯鍵限制 (primary key constraints)
INSERT INTO shop_88 (id, name, cat_id, price, remote_url, local_url)
VALUES
(2,'Brown Brim',3,25,'https://i.ibb.co/ZYW3VTp/brown-brim.png','/img/hats/brown-brim.png')

-- 實體完整限制 (entity integrity constraitns)
INSERT INTO shop_88 (id, name, cat_id, price, remote_url, local_url)
VALUES
(null,'Brown Brim',3,25,'https://i.ibb.co/ZYW3VTp/brown-brim.png','/img/hats/brown-brim.png')
